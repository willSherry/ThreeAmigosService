...
public class DebugController : ControllerBase
{
    ...
    private readonly IUndercutterService _underCuttersService;
    private readonly IProductsRepo _productsRepo;


    public DebugController(ILogger<DebugController> logger,
    IUndercutterService underCuttersService, IProductsRepo productsRepo)
    {
        _logger = logger;
    ...
    public async Task<IActionResult> UnderCutters()
    {
        ...
        {
            _logger.LogWarning("Exception occured using UnderCutters service.");
    ...
    public async Task<IActionResult> Repo()
    {
        ...
        {
            _logger.LogWarning("Exception occurred using Products rep.");
